...
class CopyTradingMixin(RestCallMixin):
    """CopyTradingMixin 方法集合（OKX REST 端点）。"""
    ...
    def copytrading_get_current_subpositions(
        ...
        **kwargs: Any,
        ...
        """Get existing lead positions"""
        return self._rest("copytrading_get_current_subpositions", inst_type, inst_id, after, before, limit, extra_data, **kwargs)
    ...
    def async_copytrading_get_current_subpositions(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("copytrading_get_current_subpositions", inst_type, inst_id, after, before, limit, extra_data, **kwargs)
    ...
    def copytrading_get_subpositions_history(
        ...
        **kwargs: Any,
        ...
        """Lead position history"""
        return self._rest("copytrading_get_subpositions_history", inst_type, inst_id, after, before, limit, extra_data, **kwargs)
    ...
    def async_copytrading_get_subpositions_history(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("copytrading_get_subpositions_history", inst_type, inst_id, after, before, limit, extra_data, **kwargs)
    ...
    def _copytrading_get_instruments(
        ...
        params: dict[str, Any] = {}
        return self._finish(
            "copytrading_get_instruments",
            params,
            extra_data,
            "ALL",
            CopyTradingMixin._copytrading_get_instruments_normalize_function,
            kwargs,
        )
    ...
    def copytrading_get_instruments(self, extra_data: Any = None, **kwargs: Any) -> Any:
        """Leading instruments"""
        return self._rest("copytrading_get_instruments", extra_data, **kwargs)

    def async_copytrading_get_instruments(
        self, extra_data: Any = None, **kwargs: Any
    ) -> None:
        """Async leading instruments"""
        return self._rest_async("copytrading_get_instruments", extra_data, **kwargs)
    ...
    def _copytrading_get_profit_sharing_details(
        ...
        **kwargs: Any,
        ...
        if limit:
            params["limit"] = limit
        return self._finish(
            "copytrading_get_profit_sharing_details",
            params,
            extra_data,
            "ALL",
            CopyTradingMixin._copytrading_get_profit_sharing_details_normalize_function,
            kwargs,
        )
    ...
    def copytrading_get_profit_sharing_details(
        ...
        **kwargs: Any,
        ...
        """Profit sharing details"""
        return self._rest("copytrading_get_profit_sharing_details", after, before, limit, extra_data, **kwargs)
    ...
    def async_copytrading_get_profit_sharing_details(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("copytrading_get_profit_sharing_details", after, before, limit, extra_data, **kwargs)
    ...
    def _copytrading_get_total_profit_sharing(
        ...
        params: dict[str, Any] = {}
        return self._finish(
            "copytrading_get_total_profit_sharing",
            params,
            extra_data,
            "ALL",
            CopyTradingMixin._copytrading_get_total_profit_sharing_normalize_function,
            kwargs,
        )
    ...
    def copytrading_get_total_profit_sharing(
        ...
        """Total profit sharing"""
        return self._rest("copytrading_get_total_profit_sharing", extra_data, **kwargs)

    def async_copytrading_get_total_profit_sharing(
        self, extra_data: Any = None, **kwargs: Any
    ) -> None:
        """Async total profit sharing"""
        return self._rest_async("copytrading_get_total_profit_sharing", extra_data, **kwargs)
    ...
    def _copytrading_get_unrealized_profit_sharing_details(
        ...
        **kwargs: Any,
        ...
        if limit:
            params["limit"] = limit
        return self._finish(
            "copytrading_get_unrealized_profit_sharing_details",
            params,
            extra_data,
            "ALL",
            CopyTradingMixin._copytrading_get_unrealized_profit_sharing_details_normalize_function,
            kwargs,
        )
    ...
    def copytrading_get_unrealized_profit_sharing_details(
        ...
        **kwargs: Any,
        ...
        """Unrealized profit sharing details"""
        return self._rest("copytrading_get_unrealized_profit_sharing_details", after, before, limit, extra_data, **kwargs)
    ...
    def async_copytrading_get_unrealized_profit_sharing_details(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("copytrading_get_unrealized_profit_sharing_details", after, before, limit, extra_data, **kwargs)
    ...
    def _copytrading_get_total_unrealized_profit_sharing(
        ...
        params: dict[str, Any] = {}
        return self._finish(
            "copytrading_get_total_unrealized_profit_sharing",
            params,
            extra_data,
            "ALL",
            CopyTradingMixin._copytrading_get_total_unrealized_profit_sharing_normalize_function,
            kwargs,
        )
    ...
    def copytrading_get_total_unrealized_profit_sharing(
        ...
        """Total unrealized profit sharing"""
        return self._rest("copytrading_get_total_unrealized_profit_sharing", extra_data, **kwargs)

    def async_copytrading_get_total_unrealized_profit_sharing(
        self, extra_data: Any = None, **kwargs: Any
    ) -> None:
        """Async total unrealized profit sharing"""
        return self._rest_async("copytrading_get_total_unrealized_profit_sharing", extra_data, **kwargs)
    ...
    def _copytrading_get_config(
        ...
        params: dict[str, Any] = {}
        return self._finish(
            "copytrading_get_config",
            params,
            extra_data,
            "ALL",
            CopyTradingMixin._copytrading_get_config_normalize_function,
            kwargs,
        )
    ...
    def copytrading_get_config(self, extra_data: Any = None, **kwargs: Any) -> Any:
        """Account configuration"""
        return self._rest("copytrading_get_config", extra_data, **kwargs)

    def async_copytrading_get_config(
        self, extra_data: Any = None, **kwargs: Any
    ) -> None:
        """Async account configuration"""
        return self._rest_async("copytrading_get_config", extra_data, **kwargs)
    ...
    def _copytrading_get_copy_settings(
        ...
        params: dict[str, Any] = {}
        return self._finish(
            "copytrading_get_copy_settings",
            params,
            extra_data,
            "ALL",
            CopyTradingMixin._copytrading_get_copy_settings_normalize_function,
            kwargs,
        )
    ...
    def copytrading_get_copy_settings(
        ...
        """Get copy settings"""
        return self._rest("copytrading_get_copy_settings", extra_data, **kwargs)

    def async_copytrading_get_copy_settings(
        self, extra_data: Any = None, **kwargs: Any
    ) -> None:
        """Async get copy settings"""
        return self._rest_async("copytrading_get_copy_settings", extra_data, **kwargs)
    ...
    def _copytrading_get_batch_leverage_info(
        ...
        params: dict[str, Any] = {}
        return self._finish(
            "copytrading_get_batch_leverage_info",
            params,
            extra_data,
            "ALL",
            CopyTradingMixin._copytrading_get_batch_leverage_info_normalize_function,
            kwargs,
        )
    ...
    def copytrading_get_batch_leverage_info(
        ...
        """My lead traders"""
        return self._rest("copytrading_get_batch_leverage_info", extra_data, **kwargs)

    def async_copytrading_get_batch_leverage_info(
        self, extra_data: Any = None, **kwargs: Any
    ) -> None:
        """Async my lead traders"""
        return self._rest_async("copytrading_get_batch_leverage_info", extra_data, **kwargs)
    ...
    def _copytrading_get_copy_trading_configuration(
        ...
        params: dict[str, Any] = {}
        return self._finish(
            "copytrading_get_copy_trading_configuration",
            params,
            extra_data,
            "ALL",
            CopyTradingMixin._copytrading_get_copy_trading_configuration_normalize_function,
            kwargs,
        )
    ...
    def copytrading_get_copy_trading_configuration(
        ...
        """Copy trading configuration"""
        return self._rest("copytrading_get_copy_trading_configuration", extra_data, **kwargs)

    def async_copytrading_get_copy_trading_configuration(
        self, extra_data: Any = None, **kwargs: Any
    ) -> None:
        """Async copy trading configuration"""
        return self._rest_async("copytrading_get_copy_trading_configuration", extra_data, **kwargs)
    ...
    def copytrading_public_lead_traders(
        ...
        **kwargs: Any,
        ...
        """Lead trader ranks (public)"""
        return self._rest("copytrading_public_lead_traders", inst_type, sort_by, uly, after, before, limit, extra_data, **kwargs)
    ...
    def async_copytrading_public_lead_traders(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("copytrading_public_lead_traders", inst_type, sort_by, uly, after, before, limit, extra_data, **kwargs)
    ...
    def _copytrading_public_weekly_pnl(
        ...
        **kwargs: Any,
        ...
        if limit:
            params["limit"] = limit
        return self._finish(
            "copytrading_public_weekly_pnl",
            params,
            extra_data,
            copy_inst_id,
            CopyTradingMixin._copytrading_public_weekly_pnl_normalize_function,
            kwargs,
        )
    ...
    def copytrading_public_weekly_pnl(
        ...
        **kwargs: Any,
        ...
        """Lead trader weekly PnL (public)"""
        return self._rest("copytrading_public_weekly_pnl", copy_inst_id, after, before, limit, extra_data, **kwargs)
    ...
    def async_copytrading_public_weekly_pnl(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("copytrading_public_weekly_pnl", copy_inst_id, after, before, limit, extra_data, **kwargs)
    ...
    def _copytrading_public_pnl(
        ...
        **kwargs: Any,
        ...
        if limit:
            params["limit"] = limit
        return self._finish(
            "copytrading_public_pnl",
            params,
            extra_data,
            copy_inst_id,
            CopyTradingMixin._copytrading_public_pnl_normalize_function,
            kwargs,
        )
    ...
    def copytrading_public_pnl(
        ...
        **kwargs: Any,
        ...
        """Lead trader daily PnL (public)"""
        return self._rest("copytrading_public_pnl", copy_inst_id, after, before, limit, extra_data, **kwargs)
    ...
    def async_copytrading_public_pnl(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("copytrading_public_pnl", copy_inst_id, after, before, limit, extra_data, **kwargs)
    ...
    def _copytrading_public_stats(
        ...
        return self._finish(
            "copytrading_public_stats",
            params,
            extra_data,
            copy_inst_id,
            CopyTradingMixin._copytrading_public_stats_normalize_function,
            kwargs,
        )
    ...
    def copytrading_public_stats(
        ...
        """Lead trader stats (public)"""
        return self._rest("copytrading_public_stats", copy_inst_id, extra_data, **kwargs)

    def async_copytrading_public_stats(
        self, copy_inst_id: Any, extra_data: Any = None, **kwargs: Any
    ) -> None:
        """Async lead trader stats (public)"""
        return self._rest_async("copytrading_public_stats", copy_inst_id, extra_data, **kwargs)
    ...
    def _copytrading_public_preference_currency(
        ...
        return self._finish(
            ...
            extra_data,
            copy_inst_id,
            CopyTradingMixin._copytrading_public_preference_currency_normalize_function,
            kwargs,
        )
    ...
    def copytrading_public_preference_currency(
        ...
        """Lead trader currency preferences (public)"""
        return self._rest("copytrading_public_preference_currency", copy_inst_id, extra_data, **kwargs)

    def async_copytrading_public_preference_currency(
        self, copy_inst_id: Any, extra_data: Any = None, **kwargs: Any
    ) -> None:
        """Async lead trader currency preferences (public)"""
        return self._rest_async("copytrading_public_preference_currency", copy_inst_id, extra_data, **kwargs)
    ...
    def _copytrading_public_current_subpositions(
        ...
        **kwargs: Any,
        ...
        return self._finish(
            ...
            extra_data,
            copy_inst_id,
            CopyTradingMixin._copytrading_public_current_subpositions_normalize_function,
            kwargs,
        )
    ...
    def copytrading_public_current_subpositions(
        ...
        **kwargs: Any,
        ...
        """Lead trader current positions (public)"""
        return self._rest("copytrading_public_current_subpositions", copy_inst_id, after, before, limit, extra_data, **kwargs)
    ...
    def async_copytrading_public_current_subpositions(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("copytrading_public_current_subpositions", copy_inst_id, after, before, limit, extra_data, **kwargs)
    ...
    def _copytrading_public_subpositions_history(
        ...
        **kwargs: Any,
        ...
        return self._finish(
            ...
            extra_data,
            copy_inst_id,
            CopyTradingMixin._copytrading_public_subpositions_history_normalize_function,
            kwargs,
        )
    ...
    def copytrading_public_subpositions_history(
        ...
        **kwargs: Any,
        ...
        """Lead trader position history (public)"""
        return self._rest("copytrading_public_subpositions_history", copy_inst_id, after, before, limit, extra_data, **kwargs)
    ...
    def async_copytrading_public_subpositions_history(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("copytrading_public_subpositions_history", copy_inst_id, after, before, limit, extra_data, **kwargs)
    ...
    def _copytrading_public_copy_traders(
        ...
        **kwargs: Any,
        ...
        if limit:
            params["limit"] = limit
        return self._finish(
            "copytrading_public_copy_traders",
            params,
            extra_data,
            copy_inst_id,
            CopyTradingMixin._copytrading_public_copy_traders_normalize_function,
            kwargs,
        )
    ...
    def copytrading_public_copy_traders(
        ...
        **kwargs: Any,
        ...
        """Copy traders (public)"""
        return self._rest("copytrading_public_copy_traders", copy_inst_id, after, before, limit, extra_data, **kwargs)
    ...
    def async_copytrading_public_copy_traders(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("copytrading_public_copy_traders", copy_inst_id, after, before, limit, extra_data, **kwargs)
