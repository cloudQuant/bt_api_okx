...
class StatisticsMixin(RestCallMixin):
    """StatisticsMixin 方法集合（OKX REST 端点）。"""
    def _get_taker_volume_contract(
        ...
        **kwargs: Any,
        ...
        return self._finish(
            ...
            extra_data,
            ccy or "ALL",
            StatisticsMixin._get_taker_volume_contract_normalize_function,
            kwargs,
        )
    ...
    def get_taker_volume_contract(
        ...
        **kwargs: Any,
        ...
        """Get contract active buy/sell volume (taker volume)"""
        return self._rest("get_taker_volume_contract", ccy, inst_type, begin, end, period, limit, extra_data, **kwargs)
    ...
    def async_get_taker_volume_contract(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_taker_volume_contract", ccy, inst_type, begin, end, period, limit, extra_data, **kwargs)
    ...
    def _get_margin_loan_ratio(
        ...
        **kwargs: Any,
        ...
        if limit:
            params["limit"] = limit
        return self._finish(
            "get_margin_loan_ratio",
            params,
            extra_data,
            ccy or "ALL",
            StatisticsMixin._get_margin_loan_ratio_normalize_function,
            kwargs,
        )
    ...
    def get_margin_loan_ratio(
        ...
        **kwargs: Any,
        ...
        """Get margin loan ratio (spot long/short ratio)"""
        return self._rest("get_margin_loan_ratio", ccy, begin, end, period, limit, extra_data, **kwargs)
    ...
    def async_get_margin_loan_ratio(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_margin_loan_ratio", ccy, begin, end, period, limit, extra_data, **kwargs)
    ...
    def _get_option_long_short_ratio(
        ...
        **kwargs: Any,
        ...
        if limit:
            params["limit"] = limit
        return self._finish(
            "get_option_long_short_ratio",
            params,
            extra_data,
            ccy or "ALL",
            StatisticsMixin._get_option_long_short_ratio_normalize_function,
            kwargs,
        )
    ...
    def get_option_long_short_ratio(
        ...
        **kwargs: Any,
        ...
        """Get option long/short ratio"""
        return self._rest("get_option_long_short_ratio", ccy, currency, begin, end, period, limit, extra_data, **kwargs)
    ...
    def async_get_option_long_short_ratio(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_option_long_short_ratio", ccy, currency, begin, end, period, limit, extra_data, **kwargs)
    ...
    def _get_contracts_oi_volume(
        ...
        **kwargs: Any,
        ...
        if limit:
            params["limit"] = limit
        return self._finish(
            "get_contracts_oi_volume",
            params,
            extra_data,
            ccy or "ALL",
            StatisticsMixin._get_contracts_oi_volume_normalize_function,
            kwargs,
        )
    ...
    def get_contracts_oi_volume(
        ...
        **kwargs: Any,
        ...
        """Get contract open interest and volume"""
        return self._rest("get_contracts_oi_volume", ccy, begin, end, period, limit, extra_data, **kwargs)
    ...
    def async_get_contracts_oi_volume(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_contracts_oi_volume", ccy, begin, end, period, limit, extra_data, **kwargs)
    ...
    def _get_option_oi_volume(
        ...
        **kwargs: Any,
        ...
        if limit:
            params["limit"] = limit
        return self._finish(
            "get_option_oi_volume",
            params,
            extra_data,
            ccy or "ALL",
            StatisticsMixin._get_option_oi_volume_normalize_function,
            kwargs,
        )
    ...
    def get_option_oi_volume(
        ...
        **kwargs: Any,
        ...
        """Get option open interest and volume"""
        return self._rest("get_option_oi_volume", ccy, currency, begin, end, period, limit, extra_data, **kwargs)
    ...
    def async_get_option_oi_volume(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_option_oi_volume", ccy, currency, begin, end, period, limit, extra_data, **kwargs)
    ...
    def _get_option_oi_volume_expiry(
        ...
        **kwargs: Any,
        ...
        # 合并后该归一化函数与本方法同属 StatisticsMixin，直接类内引用即可。
    ...
    def get_option_oi_volume_expiry(
        ...
        **kwargs: Any,
        ...
        """Get option open interest and volume by expiry"""
        return self._rest("get_option_oi_volume_expiry", ccy, currency, begin, end, period, limit, extra_data, **kwargs)
    ...
    def async_get_option_oi_volume_expiry(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_option_oi_volume_expiry", ccy, currency, begin, end, period, limit, extra_data, **kwargs)
    ...
    def _get_option_oi_volume_strike(
        ...
        **kwargs: Any,
        ...
        if limit:
            params["limit"] = limit
        return self._finish(
            "get_option_oi_volume_strike",
            params,
            extra_data,
            ccy or "ALL",
            StatisticsMixin._get_option_oi_volume_strike_normalize_function,
            kwargs,
        )
    ...
    def get_option_oi_volume_strike(
        ...
        **kwargs: Any,
        ...
        """Get option open interest and volume by strike price"""
        return self._rest("get_option_oi_volume_strike", ccy, currency, begin, end, period, limit, extra_data, **kwargs)
    ...
    def async_get_option_oi_volume_strike(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_option_oi_volume_strike", ccy, currency, begin, end, period, limit, extra_data, **kwargs)
    ...
    def _get_option_taker_flow(
        ...
        **kwargs: Any,
        ...
        if limit:
            params["limit"] = limit
        return self._finish(
            "get_option_taker_flow",
            params,
            extra_data,
            ccy or "ALL",
            StatisticsMixin._get_option_taker_flow_normalize_function,
            kwargs,
        )
    ...
    def get_option_taker_flow(
        ...
        **kwargs: Any,
        ...
        """Get option taker block volume (large trades)"""
        return self._rest("get_option_taker_flow", ccy, currency, begin, end, period, limit, extra_data, **kwargs)
    ...
    def async_get_option_taker_flow(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_option_taker_flow", ccy, currency, begin, end, period, limit, extra_data, **kwargs)
    ...
    def _get_support_coin(
        ...
        return self._finish(
            ...
            extra_data,
            "ALL",
            StatisticsMixin._get_support_coin_normalize_function,
            kwargs,
        )

    def get_support_coin(self, extra_data: Any = None, **kwargs: Any) -> Any:
        """Get support coin"""
        return self._rest("get_support_coin", extra_data, **kwargs)

    def async_get_support_coin(self, extra_data: Any = None, **kwargs: Any) -> None:
        """Async get support coin"""
        return self._rest_async("get_support_coin", extra_data, **kwargs)
    ...
    def _get_contract_oi_history(
        ...
        **kwargs: Any,
        ...
        if period:
            params["period"] = period
        return self._finish(
            "get_contract_oi_history",
            params,
            extra_data,
            inst_id or uly or ccy or "ALL",
    ...
    def get_contract_oi_history(
        ...
        **kwargs: Any,
        ...
        """Get contract open interest history"""
        return self._rest("get_contract_oi_history", ccy, uly, inst_id, after, before, limit, period, extra_data, **kwargs)
    ...
    def async_get_contract_oi_history(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_contract_oi_history", ccy, uly, inst_id, after, before, limit, period, extra_data, **kwargs)
    ...
    def get_taker_volume(
        ...
        **kwargs: Any,
        ...
        """Get taker volume"""
        return self._rest("get_taker_volume", ccy, uly, inst_id, begin, end, period, extra_data, **kwargs)
    ...
    def async_get_taker_volume(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_taker_volume", ccy, uly, inst_id, begin, end, period, extra_data, **kwargs)
    ...
    def get_long_short_ratio(
        ...
        **kwargs: Any,
        ...
        """Get long short ratio"""
        return self._rest("get_long_short_ratio", ccy, begin, end, period, extra_data, **kwargs)
    ...
    def async_get_long_short_ratio(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_long_short_ratio", ccy, begin, end, period, extra_data, **kwargs)
    ...
    def _get_long_short_ratio_top_trader(
        ...
        **kwargs: Any,
        ...
        if period:
            params["period"] = period
        return self._finish(
            "get_long_short_ratio_top_trader",
            params,
            extra_data,
            ccy or "ALL",
            generic_normalize_function,
    ...
    def get_long_short_ratio_top_trader(
        ...
        **kwargs: Any,
        ...
        """Get long short ratio (top trader)"""
        return self._rest("get_long_short_ratio_top_trader", ccy, begin, end, period, extra_data, **kwargs)
    ...
    def async_get_long_short_ratio_top_trader(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_long_short_ratio_top_trader", ccy, begin, end, period, extra_data, **kwargs)
    ...
    def get_contract_long_short_ratio(
        ...
        **kwargs: Any,
        ...
        """Get contract long short ratio"""
        return self._rest("get_contract_long_short_ratio", ccy, uly, inst_id, begin, end, period, limit, extra_data, **kwargs)
    ...
    def async_get_contract_long_short_ratio(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_contract_long_short_ratio", ccy, uly, inst_id, begin, end, period, limit, extra_data, **kwargs)
    ...
    def get_put_call_ratio(
        ...
        **kwargs: Any,
        ...
        """Get put call ratio"""
        return self._rest("get_put_call_ratio", ccy, uly, begin, end, period, extra_data, **kwargs)
    ...
    def async_get_put_call_ratio(
        ...
        **kwargs: Any,
        ...
        return self._rest_async("get_put_call_ratio", ccy, uly, begin, end, period, extra_data, **kwargs)
